                  ...
                  {!shareCode ? (
                    ...
                    <div className="space-y-4">
                      <div className="p-4 bg-muted rounded-lg">
                        ...
                        <p className="text-center font-mono text-lg select-all">{shareCode}</p>
                      </div>

                      <div className="flex justify-center">
                        <QRCodeSVG value={shareCode} size={150} className="border-4 border-white rounded-lg" />
                      </div>
                        ...
                        {isConnected && (
                          <>
                            ...
                            <div className="flex justify-between text-xs text-muted-foreground">
                              ...
                              <span>{estimatedTime > 0 ? `${estimatedTime} seconds remaining` : "Calculating..."}</span>
                            </div>
                          </>
                        )}
                      </div>
            ...
            <div className="flex flex-col items-center justify-center p-6 border-2 border-dashed rounded-lg border-muted-foreground/25 hover:border-primary/50 transition-colors">
              <div className="w-full space-y-4">
                <div className="space-y-2 text-center">
                  ...
                  <p className="text-muted-foreground">Enter the code shared by the sender</p>
                </div>
